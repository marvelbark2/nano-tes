...
@section('content')
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        <span class="heading">{{ auth()->user()->reputation }}</span>
                                        <span class="description">{{ __('Points') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{$votecount}}</span>
                                        <span class="description">{{ __('Votes') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('dob') ? ' has-danger' : '' }}">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control datepicker" placeholder="Select date" type="dob" name="dob" value="{{ auth()->user()->dob }}">
                                        </div>
                                    </div>
    ...
    <script src="../../assets/demo/vendor/prism.js"></script>
